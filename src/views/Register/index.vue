<template>
  <div class="content">
    <div class="login-content">
      <a href="" class="banner-box">宜宾政务服务平台</a>
      <div class="login-box">
        <h1>账号注册</h1>
        <input type="text" placeholder="用户名" v-model="registerFrom.username">
        <input type="text" placeholder="邮箱" v-model="registerFrom.email">
        <input type="password" placeholder="密码" v-model="registerFrom.passwd">
        <input type="text" placeholder="验证码" v-model="registerFrom.captcha"><button class="yzm"
    ...
    async userRegister() {
      try {
        let info = {
          ...
          passwd: this.registerFrom.passwd,
...
.yzm {
  ...
  /* border-radius:2px; */
  width: 40px;
  background-color: rgb(208, 204, 196);
  top: 300px;
  left: 290px;
}
.tologin{
