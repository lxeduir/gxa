    ...
    <div class="backgroud">
        <div class="message">
            ...
            <div>
                <pre>政治面貌</pre>
                <div class="polstatus">
                    <el-radio v-model="polstatus" label="1">党员</el-radio>
                    <el-radio v-model="polstatus" label="2">团员</el-radio>
                    <el-radio v-model="polstatus" label="3">其他</el-radio>                      
                </div>
            </div>
            <div>
                <pre>证    件</pre>
